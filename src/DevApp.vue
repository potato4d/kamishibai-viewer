<template>
  <div class="devapp-container">
    <div class="devapp-container_content">
      <h1>
        <span>Kamishibai Viewer v1.0.0</span><br />
        <small>
          <small>
    ...
    <div class="devapp-container_content">
      ...
      <p>
        Kamishibai is a under development library.<br />
    ...
    <div class="devapp-container_content">
      ...
      <p>
        ...
        demo:
        <a
          href="https://potato4d.github.io/kamishibai-viewer/dist/1.0.0/demo.html"
          >https://potato4d.github.io/kamishibai-viewer/dist/1.0.0/demo.html</a
        >
      </p>
    </div>
    ...
    <div class="devapp-container_content">
      ...
      <div>
        <pre>
          ...
          <code>&lt;script src="https://potato4d.github.io/kamishibai/dist/1.0.0/kamishibai.min.js"&gt;&lt;/script&gt;</code>
        </pre>
      </div>
      <p>2. Write custom element tag for your HTML</p>
      <div>
        <pre>
          <code>&lt;kamishibai-viewer data-item-id="4ff5873776992f0511d6"&gt;&lt;/kamishibai-viewer&gt;</code>
        </pre>
      </div>
      <p>3. Done!</p>
    </div>
    ...
    <div class="devapp-container_content">
      <h2>LICENSE</h2>
      <p>
        MIT @ HANATANI Takuma(@potato4d)<br />
    ...
    <div class="devapp-container_content">
      <div class="text-center">
        <small> &copy; 2018 HANATANI Takuma(@potato4d) </small>
      </div>
    </div>
  </div>
</template>
...
.devapp-container_content h1 {
  text-align: center;
}
.devapp-container_content small {
  font-size: 0.8em;
}
